...
var MessageModel = /** @class */ (function (_super) {
    ...
    MessageModel.get_chat_messages_with_sender = function (chat_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, MessageModel_1.find({ relations: ['sender'], where: { chat: chat_id } })];
    ...
    __decorate([
        typeorm_1.ManyToOne(function (type) { return ChatModel_1.ChatModel; }, function (chat) { return chat.messages; }),
