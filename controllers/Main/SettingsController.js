...
class SittingsController extends Controller_1.Controller {
    change_settings_menu(menu_type = "settings") {
            ...
            switch (menu_type) {
                case 'settings':
                    data = {
                        ...
                        name: yield this.loom.get_token_name(),
                        label: yield this.loom.get_token_label(),
                        contract_address: this.loom.token_addr,
                        amount: yield this.loom.get_my_balance(),
                        total_supply: yield this.loom.get_total_supply(),
                    };
                    // this.send_data('settings_table', this.render(`main/settings/settings_table.pug`, data));
                    break;
                default:
...
module.exports = SittingsController;
